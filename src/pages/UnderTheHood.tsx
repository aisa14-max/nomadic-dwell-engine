...
import ConfiguratorPortfolio from "./ConfiguratorPortfolio";
    ...
    <AnimatePresence mode="wait">
      {!showEngine ? (
        <motion.div
          ...
          className="relative min-h-screen w-full overflow-hidden bg-[#02030a] text-white"
        >
